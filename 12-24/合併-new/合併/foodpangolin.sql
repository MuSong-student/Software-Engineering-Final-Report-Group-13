...
(57, 0, 1, NULL, 4, 1, 1, '待接單', '2024-12-23 14:40:10', NULL, NULL, 120),
...
--
ALTER TABLE `account`
  MODIFY `A_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `item`
  MODIFY `I_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
...
--
ALTER TABLE `orders`
  MODIFY `O_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
