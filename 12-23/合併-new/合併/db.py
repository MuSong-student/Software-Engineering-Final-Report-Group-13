...
def add_to_cart(customer_id, restaurant_id, menu_id, quantity):
    ...
    try:
        ...
        cart.append({
            'item_id': cursor.lastrowid,  # 获取插入的item的ID
...
def create_order(user_id, restaurant_id, total_price):
    ...
    try:
        ...
        """
        cursor.execute(orders_query, (restaurant_id, user_id, total_price))
...
def update_cart_items_order_id(user_id, restaurant_id, order_id):
    connection = connect_db()
    cursor = connection.cursor()
...
def place_order_in_db(user_id, restaurant_id, total_price, quantities):
    connection = connect_db()
    cursor = connection.cursor()
    print(user_id, restaurant_id, total_price, quantities)
    ...
    try:
        ...
        cursor.execute(clear_cart_query, (user_id, restaurant_id))
